    ...
    <LightTheme>
      <div>
        ...
        <div id="wrap">
                ...
                <div className="col-sm-5">
                  <nav>
                    <ul className="cd-primary-nav">
                      ...
                      <li className="drop-menu">
                        ...
                        <div className="collapse" id="down-1">
                          <div className="well">
                            <ul>
                              <li>
                                <a href="shop_01.html">Shop 1</a>
                              </li>
                              <li>
                                <a href="shop_02.html">Shop 2</a>
                              </li>
                              <li>
                                <a href="shop_03.html">Shop 3</a>
                              </li>
                              <li>
                                <a href="shop_04.html">Shop 4</a>
                              </li>
                              <li>
                      ...
                      <li>
                        <a href="blog-list_01.html"> Blog</a>
                      </li>
                      <li>
                ...
                <nav className="navbar">
                  <div className="nav-right">
                    <ul className="navbar-right">
                      <li className="dropdown user-acc">
                        <a
                          href="#"
                      ...
                      <li className="dropdown user-basket">
                        <a
                          href="#"
                          className="dropdown-toggle"
                          data-toggle="dropdown"
                        ...
                        <ul className="dropdown-menu">
                          <li>
                            ...
                            <div className="media-body">
                              ...
                              <span className="price">129.00 USD</span>
                      ...
                      <li className="dropdown">
                        ...
                        <div className="search-inside animated bounceInUp">
                          <i className="icon-close search-close"></i>
          ...
          <main>
            <section
              className="home-slider simple-head"
              ...
              <div className="container-fluid">
                <div className="position-center-center">
                  <div className="col-lg-7 col-lg-offset-5">
                    ...
                    <h1 className="extra-huge-text">look hot with style</h1>
                    <div className="text-center">
                      <a href="#." className="btn btn-round margin-top-40">
                        SHOP NOW
                      </a>
                    </div>
                  </div>
                ...
                <div className="container">
                  <div className="heading text-center">
                    ...
                    <span>
                      ...
                      Donec faucibus maximus vehicula. Sed feugiat, tellus vel
                      ...
                      <li className="col-md-6">
                        <article>
                          ...
                          <div className="position-center-center">
                            ...
                            <a href="#." className="btn btn-small btn-round">
                              MORE
                            </a>
                          </div>
                        </article>
                  ...
                  <div className="papular-block block-slide">
                    <div className="item">
                      <div className="item-img">
                        <img
                          className="img-1"
                          src="images/shop-3-img-1.jpg"
                          alt=""
                        />
                        <img
                          className="img-2"
                          src="images/shop-3-img-4.jpg"
                          alt=""
                        />
              ...
              <section className="special-offers">
                <div className="container">
                  <div className="col-md-8 center-block">
                    <h4>special</h4>
                    <h1 className="extra-huge-text"> women’s sale </h1>
                    <a href="#." className="btn btn-round margin-top-50">
                      SHOP NOW
                    </a>
                  </div>
                </div>
              ...
              <section className="small-about padding-top-150 padding-bottom-150">
                <div className="container">
                  <div className="heading text-center">
                    <h4>about ecoshop</h4>
                    <p>
                      Phasellus lacinia fermentum bibendum. Interdum et
                      malesuada fames ac ante ipsumien lacus, eu posuere odio
                      luctus non. Nulla lacinia, eros vel fermentum consectetur,
                      risus purus tempc, et iaculis odio dolor in ex.
                    </p>
                  </div>
              ...
              <section className="news-letter style-2 padding-top-150 padding-bottom-150">
                <div className="container">
                  <div className="heading light-head text-center margin-bottom-30">
                    ...
                    <span>
                      Phasellus lacinia fermentum bibendum. Interdum et
                      malesuada fames ac ante ipsumien lacus, eu posuere odi
                    </span>
                  </div>
                  <form>
                    <input
              ...
              <div className="container">
                <div className="col-md-3">
                  <div className="about-footer">
                    ...
                    />
                    <p>
                      <i className="icon-pointer"></i> Street No. 12, Newyork
                      12, <br />
                      MD - 123, USA.
                    </p>
                    <p>
